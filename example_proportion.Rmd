...
.pull-left[
Consider a sample of 10 voters (randomly chosen) a shown on the right. By chance we have 5 voters for Biden and 5 for Trump so it seems intuitive to say that .purple[our best guess] based on the available data is that 50% of the voters will vote for Biden (i.e. 5/10 $\times$ 100 %).
