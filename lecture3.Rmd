...
```{r}
treatment_score = c(43, 48, 41, 53, 42, 55, 49, 47, 60, 45,
                    49, 42, 50, 60, 61, 59, 63, 58, 66, 69)
...
```{r}
treatment_age = c(6.01, 6.06, 6.22, 6.28, 6.60, 6.63, 6.67, 6.71, 6.73, 6.76,
                  7.10, 7.17, 7.20, 7.34, 7.54, 7.80, 7.86, 8.27, 8.58, 8.89)
control_age   = c(6.42, 6.46, 7.54, 7.88, 8.51, 8.60, 8.75, 8.81, 8.92, 9.10,
                  9.69, 10.09, 10.75, 10.81, 10.87, 11.74, 11.98, 12.40, 12.51, 12.81)
```
...
- $\hat{\beta}_0 = -2.6355$ represents the estimated baseline average score of the DRP test.
- $\hat{\beta}_1 = 10.8228$ means that .pink[for a student of the same age], participating the new directed reading activities is estimated to increase their average score of the DRP test by 10.8228.
- $\hat{\beta}_2 = 6.5388$ means that .pink[when a student receives the same treatment] (either participate or not in the activities), their average score increases by 6.5388 as they become 1 year older. 
...
<div align="center">
<iframe width="784" height="441" src="http://nsfwyoutube.com/watchmore?v=0Rnq1NpHdmw?start=399" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</div>
