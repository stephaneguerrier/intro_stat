...
cols = gg_color_hue(3)
barplot(c(44, 35, 41), col = cols[(c(1,3,2))], names = c("Men", "Women", "Overall"), cex.axis=2, cex.names = 2, cex.lab = 1.5, ylab = "Admission rate (%)")
...
.pull-right[
.smallest[
The data show that among .purple[8,442 men applicants 44%] were admitted while among the .pink[4,321 women applicants only 35%] were admitted. The overall admission rate was around 41%. Therefore, the data suggest that men applying were more likely than women to be admitted. The difference is quite large (9%) and based on a large sample of 12,763 applicants so it is unlikely that it is due to chance.

However, this conclusion is completely incorrect and a correct analysis showed a "small but statisticall significant bias in favor of women". But why? EMOJI
]
]
...
.pull-left[.smallest[.pink[Let us consider the individuals departments where the students are applying]
