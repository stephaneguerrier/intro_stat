...
include_graphics("pics/normal.png")
```
...
.panelset[
.panel[.panel-name[Problem]
.smallest[Returning to our Biden-Trump example, suppose we believe (or hope to show that) .pink[Biden will have more than 50% of the votes]. We collect data with $n = 600$ and $m = 322$. We will consider the following steps to set up the test:]
...
.center[All material is available on Piazza.]
